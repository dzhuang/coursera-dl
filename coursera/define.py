...
OPENCOURSE_CONTENT_URL = 'https://www.coursera.org/api/guidedCourseWeekCards.v1?ids={user_id}~{class_name}&fields=courseId,id,weeks'
OPENCOURSE_VIDEO_URL = (
    "https://www.coursera.org/api/onDemandLectureVideos.v1/{course_id}~{video_id}"
    "?includes=video&fields=onDemandVideos.v1(sources%2Csubtitles%2CsubtitlesVtt%2CsubtitlesTxt)")
...
ABOUT_URL = ('https://www.coursera.org/api/catalog.v1/courses?'
